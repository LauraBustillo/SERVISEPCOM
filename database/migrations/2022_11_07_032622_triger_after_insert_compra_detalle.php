...
class TrigerAfterInsertCompraDetalle extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared('
        CREATE TRIGGER compra_detalles_after_insert AFTER INSERT ON `compra_detalles` FOR EACH ROW
        BEGIN
    ...
    {
        DB::unprepared('DROP TRIGGER `compra_detalles_after_insert`');
    }
}
