        ...
        <div class="modal-body" > 
          ...
          <div style="display: flex">
            <div style="width: 100%">
              ...
              <input  id="numero_facturaR" type="text"  maxlength="11" name="numero_facturaR" class="form-control" 
...
<script>
  ...
  function openmodalfacturar(mante){
    ...
    document.getElementById('numero_facturaR').value = mante.numero_factura ;
    document.getElementById('fecha_facturacionR').value = mante.fecha_factura ;
  ...
  function guardarfacturar(){
      ...
      var id_r = document.getElementById('id_m').value;
    ...
    }else if(numero_facturaR.length > 11){
 ...
 // Descripcion
    if (document.getElementById("descripcion_reparacion").value == '') {
      ...
      var datosRep = {
        "id":id_r,
        "numero_facturaR":numero_facturaR,
        "fecha_facturacionR":fecha_facturacionR,
