...
{{--Botones --}}
<a class="button button-blue " href="{{route('reparacion.mostrar' , ['id' => $detalle->id]) }}"> <i
        class="bi bi-pen-fill"> Editar </i></a>
<a class="button button-blue " href="{{route('reparacion.index')}}">
    <i class="bi bi-arrow-left-circle-fill"> Volver
    </i>
</a>
<a class="button button-blue " href="{{route('pdf.reparacion',['id' => $detalle->id])}}">
    <i class="bi bi-printer-fill"> Imprimir
    </i>
</a>

<a class="button button-blue " href="{{route('pdf.garantia',['id' => $detalle->id])}}">
