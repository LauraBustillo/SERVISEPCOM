...
<div class="form-control2"  style="width: 100%;">
  ...
  <div style="display: flex">Dirección:&nbsp; <textarea class="inputCliente" style="resize: none" readonly id="l_direccion_cliente" name="Direccion">{{old('Direccion',$mantenimiento->Direccion)}}</textarea></div>
</div>
          ...
          <table id="tablebuscarclientes" class="table table-hover tablacompras"> <br>
            ...
            <tbody id="tbody_buscarcliente">
              ...
              <tr>
                ...
                <td class="truncate">{{ $cli->Direccion }}</td>
...
{{--mensaje de confirmacion --}}
 ...
 <script>
  ...
  $(document).ready(function() {
    var maxLength = 10; // Longitud máxima del texto
    var originalText = $("#di_cliente").val();
    var truncatedText = originalText.length > maxLength ? originalText.substr(0, maxLength) + "..." : originalText;
    $("#di_cliente").val(truncatedText);
  });
