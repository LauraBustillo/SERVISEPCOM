...
<br>
  ...
  {{--Botones --}}
  <a  class="button button-blue " href="{{route('empleado.editar', ['id'=>$ver->id])}}"> <i class="bi bi-pen-fill"> Editar </i></a>
  <a  class="button button-blue " href="{{route('empleado.index')}}"> <i class="bi bi-arrow-left-circle-fill"> Volver </i></a>
