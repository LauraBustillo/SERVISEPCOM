...
<div class="row g-3">
  <div class="col">
  <input type="text" minlength="3" maxlength="25"  id="Nombre" name="Nombre" pattern="[A-Za-z]+" class="form-control" 
  ...
  <div class="col">
    ...
    pattern="[A-Za-z]+" class="form-control" required title="Este campo solo debe de contener letras" 
